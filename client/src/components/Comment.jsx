      ...
      <div className="flex-1">
        ...
        {isEditing ? (
          ...
          <div className="flex justify-end gap-2 text-xs mt-2">
            <Button  type="button" className="" size='sm' gradientDuoTone='purpleToBlue' onClick={handleSave} >Save</Button>
            <Button  type="button" className="" size='sm' gradientDuoTone='purpleToBlue' outline onClick={()=>setIsEditing(false)} >Cancel</Button>
          </div>
          </>
